...
import { addOrderTotalPrice, decreaseAmount, increaseAmount, removeAllOrderProduct, removeOrderProduct, selectedOrder } from '../../redux/slides/orderSlide';
...
const OrderPage = () => {
  ...
  const orderItemsMemo = useMemo(() => {
    const result = order?.orderItemsSelected
    return result
  }, [order])
  ...
  const deliveryPriceMemo = useMemo(() => {
    if (priceMemo >= 20000 && priceMemo < 500000) {
      return 10000
    } else if (priceMemo >= 500000 || orderItemsMemo.length === 0) {
      return 0
    } else {
      return 20000
    }
